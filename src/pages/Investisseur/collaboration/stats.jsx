...
const CollaborationStats = ({ collaborationsData, apiStats }) => {
    ...
    const calculateStats = () => {
        ...
        Object.entries(collaborationsData).forEach(([entrepreneurId, data]) => {
            ...
            if (hasFinancialCollabs) {
                stats.unique_financial_partners.add(entrepreneurId);
            }
            ...
            if (hasTechnicalCollabs) {
                stats.unique_technical_partners.add(entrepreneurId);
            }
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
                <div className="flex items-center justify-between">
                    <div>
                        <p className="text-sm font-medium text-gray-600">Partenaires Financier</p>
